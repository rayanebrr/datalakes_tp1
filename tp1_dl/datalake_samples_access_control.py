...
class DataLakeServiceSamples(object):
    ...
    connection_string = os.environ['DefaultEndpointsProtocol=https;AccountName=csb10030000ad857dcd;AccountKey=Ucyanp3webafsocW1dBu7NC+2/BV9xR3vAXQVkArymz5iAy4ycHyOKI+IiIB3KQnvHEtyZDGBgSq+AStLaromg==;EndpointSuffix=core.windows.net']
    account_name = os.getenv('STORAGE_ACCOUNT_NAME', "csb10030000ad857dcd")

    active_directory_application_id = os.getenv("413600cf-bd4e-4c7c-8a61-69e73cddf731")
    active_directory_application_secret = os.getenv("ACTIVE_DIRECTORY_APPLICATION_SECRET")
    active_directory_tenant_id = os.getenv("de5d26f9e3c644329372d80cda98dc65")
